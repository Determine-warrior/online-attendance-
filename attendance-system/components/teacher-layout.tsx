...
import { LayoutDashboard, Users, Calendar, CheckSquare, BarChart3, Settings, Menu, LogOut } from "lucide-react"
...
export function TeacherLayout({ children }: TeacherLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Mark Attendance", href: "/teacher/attendance/mark", icon: CheckSquare },
  ...
  const Sidebar = () => (
    <div className="flex flex-col h-full">
      <div className="p-6">
        <h2 className="text-2xl font-bold text-green-600">AttendanceMS</h2>
